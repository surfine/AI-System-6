 ...
 * tooling/cmf-prepare-model.mjs, which also records where they came from.
...
const MODELS = Object.freeze({
  "iphone-17-standard": {
    ...
    label: "iPhone 17",
    asset: path.join(desktopRoot, "assets", "cmf", "iphone-17-standard.usdz"),
  ...
  "iphone-17-pro": {
    id: "iphone-17-pro",
    label: "iPhone 17 Pro",
    asset: path.join(desktopRoot, "assets", "cmf", "iphone-17-pro.usdz"),
  ...
  "iphone-17-pro-max": {
    ...
    asset: path.join(desktopRoot, "assets", "cmf", "iphone-17-pro-max.usdz"),
    paletteMeta: IPHONE_17_PRO_PALETTE,
    defaultParts: {
      frame: "cosmicOrange17Pro",
      frameSide: "cosmicOrange17Pro",
  ...
  "iphone-air": {
    id: "iphone-air",
    label: "iPhone Air",
    asset: path.join(desktopRoot, "assets", "cmf", "iphone-air.usdz"),
  ...
  "iphone-17e": {
    id: "iphone-17e",
    label: "iPhone 17e",
    asset: path.join(desktopRoot, "assets", "cmf", "iphone-17e.usdz"),
  ...
  "macbook-neo": {
    id: "macbook-neo",
    label: "MacBook Neo",
    // One asset per pose: tooling/cmf-prepare-model.mjs flattens the Apple
    ...
    poses: [
      {
        id: "closed",
        label: "Closed",
        asset: path.join(desktopRoot, "assets", "cmf", "macbook-neo-closed.usdz"),
      },
      {
        id: "open",
        label: "Open",
        asset: path.join(desktopRoot, "assets", "cmf", "macbook-neo-open.usdz"),
      },
    ],
