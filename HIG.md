...
It translates the product and visual principles in [CLAUDE.md](CLAUDE.md) and
[DESIGN.md](DESIGN.md) into repeatable decisions for new applications.
...
1. Product semantics and the writing route in `CLAUDE.md`.
