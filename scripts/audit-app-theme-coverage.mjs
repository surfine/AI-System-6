...
// selectors violates the Theme Family Contract (scripts/verify-css.mjs
// ratchet blocks exactly that class of selector).
//
// Usage:
//   node scripts/audit-app-theme-coverage.mjs
//   node scripts/audit-app-theme-coverage.mjs --json drafts/theme-coverage/coverage.json
