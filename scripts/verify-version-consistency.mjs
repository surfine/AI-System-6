...
const generatedJson = readJson("app/generated/build-info.json");
const generatedJs = readText("app/generated/build-info.js");
const pkg = readJson("package.json");
const buildInfo = readJson("build-info.json");

assertFile("app/generated/build-info.js");
assertFile("app/generated/build-info.json");
assertFile("index.html");
assertFile("app/core/config.js");
...
const configSource = readText("app/core/config.js");
...
const serverLib = readText("src/server/lib/build-info.js");
...
const shellScript = readText("scripts/build-mac-shell-app.mjs");
