...
//
//   node scripts/sign-mac-app.mjs --app dist/AI-System-6.app [--entitlements path]
...
function parseArguments(argv) {
  ...
  for (let index = 0; index < argv.length; index += 1) {
    if (argv[index] === "--app") options.app = resolve(argv[index + 1]);
      ...
      console.log("Usage: node scripts/sign-mac-app.mjs --app <path.app> [--entitlements <path.plist>]");
      process.exit(0);
    }
  }
  return options;
