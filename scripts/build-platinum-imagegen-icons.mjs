...
const themeDir = join(root, "assets/themes/platinum");
...
async function buildContactSheet() {
  ...
  writeFileSync(join(root, "drafts/era-icons/platinum-contact-sheet.png"), canvas.toBuffer("image/png"));
}
...
family.generatedBy = "scripts/build-platinum-imagegen-icons.mjs";
