...
const continuityPath = join(root, "assets/themes/icon-system-continuity.json");
const outputDir = join(root, "assets/themes/classic/icons");
...
try {
  ...
  const familyManifest = {
    ...
    generatedBy: "scripts/build-classic-core-icons.mjs",
