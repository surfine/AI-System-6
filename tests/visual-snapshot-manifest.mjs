...
export const SNAPSHOT_TARGETS = [
  ...
  // --- Desktop ---
  // Applications is the stable catalogue entry on the working-set desktop;
  // mounted media and the Writing Studio switcher are intentionally dynamic.
  { sel: '.icon-column > .desktop-icon[data-open="applications"]', props: ["width", "height"] },
  { sel: '.icon-column > .desktop-icon[data-open="applications"] span:last-child', props: ["font-size", "color"] },
];
