...
const DEFAULT_CACHE_ROOT = join(root, "internal", "evidence", "drafts", "theme-lab-fidelity-cache");
const DEFAULT_OUTPUT_ROOT = join(root, "internal", "evidence", "drafts", "theme-lab-fidelity");
