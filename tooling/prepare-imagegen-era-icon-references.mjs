...
const outputRoot = join(root, "internal/evidence/drafts/era-icons/imagegen-redraw/references");
...
const resourceTool = join(root, ".claude/skills/system6-ui-review/tooling/system6_resources.py");
const nativeImage = join(root, ".claude/skills/system6-ui-review/assets/System 6.0.8 - System Startup.img");
const classicSource = JSON.parse(readFileSync(join(root, "apps/desktop/assets/themes/classic/icons/src/classic-core-standins.json"), "utf8"));
...
const platinumSource = JSON.parse(readFileSync(join(root, "apps/desktop/assets/themes/platinum/icons/src/platinum-core-icons.json"), "utf8"));
...
const ERA_ASSETS = {
  aqua: join(root, "apps/desktop/assets/themes/aqua"),
  "snow-leopard": join(root, "apps/desktop/assets/themes/snow-leopard"),
  yosemite: join(root, "apps/desktop/assets/themes/yosemite"),
};
