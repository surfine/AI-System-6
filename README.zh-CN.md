...
<!-- source-sha256: 9cd403c4135b70c7ce5de076c2ef3c7f5bb9397ac2e4479d151565d099568845 -->
...
[English](README.md) · [在线体验](https://system6.aaronlau.me) · [Mac 测试版](https://github.com/surfine/AI-System-6/releases/latest) · [演示视频](https://www.bilibili.com/video/BV1ht3m6UEDb/)
...
最方便的方式是直接打开[在线体验](https://system6.aaronlau.me)。

如果想把它当成独立桌面应用使用，可以下载 [Apple silicon Mac 测试版](https://github.com/surfine/AI-System-6/releases/latest)。它只面向 M1 或更新芯片，系统要求为 macOS 13 或更高版本。目前测试版采用临时签名，尚未经过 Apple 公证；第一次打开时，可能需要按住 Control 点按应用，再选择“打开”。

Mac 版是这套本地优先工作环境的轻量外壳。应用会自行启动和关闭内置的本地服务，项目资料和模型凭据仍留在你的 Mac 上。
