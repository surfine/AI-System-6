...
<!-- source-sha256: 524a823873a13520d7e39d0a74b7898871cafacf57eb8ff5ead931a3612c9ccb -->
...
它借用 Macintosh System 6 的克制感：小窗口、清楚的对象、主动保存，以及一次只处理一件写作任务。重点不在复古皮肤；它要保护写作者自己的语言、来源和意图。
