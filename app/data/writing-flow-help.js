    ...
    readMe: {
      ...
      sections: [
        ...
        },
        {
          ...
          en: "How To Use It",
          zhBody: [
            "先走主路线，再召唤工具。Searcher、DocMap、ClioStage、词典、翻译和 ClioTalk 都是帮手，不是新的主线。",
          ...
          enBody: [
            "Walk the main route first, then summon tools. Searcher, DocMap, ClioStage, Dictionary, Translation, and ClioTalk are helpers, not new routes.",
