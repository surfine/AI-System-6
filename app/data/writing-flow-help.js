    ...
    readMe: {
      ...
      sections: [
        ...
        },
        {
          ...
          en: "How To Use It",
          zhBody: [
            "先走主路线，再召唤工具。Searcher、Reader、DocMap、ClioChart、ClioStage、时光机、Cover Glass、词典、翻译和 ClioTalk 都是帮手，不是新的主线。",
          ...
          enBody: [
            "Walk the main route first, then summon tools. Searcher, Reader, DocMap, ClioChart, ClioStage, Time Machine, Cover Glass, Dictionary, Translation, and ClioTalk are helpers, not new routes.",
        ...
        },
        {
          ...
          zhBody: [
            ...
            "**时光机与 Cover Glass**：时光机用真实存档日期检查历史网页；Cover Glass 用场景、图层、画板和 Glass Mix 玻璃总控合成生产封面。它们的结果只有在明确摘录、保存或导出后才进入项目。",
            "**MultiFinder 与外观**：MultiFinder 保持多个应用运行，并从菜单栏切回指定应用。需要从复古界面切换到液态玻璃时，手动选择“特别 → 液态玻璃”；改变的是同一工作区的外观，不是另一套文件。",
          ...
          enBody: [
            ...
            "**Time Machine and Cover Glass**: use real archive dates in Time Machine to inspect the historical web. Use Cover Glass scene, layers, artboard, and the global Glass Mix control to compose a production cover. Their results enter the project only after an explicit clip, save, or export.",
            "**MultiFinder and appearance**: MultiFinder keeps applications running and returns to a chosen app from the menu bar. To move from Retro Interface to Liquid Glass, choose Special → Liquid Glass manually; the same workspace and files remain underneath.",
