...
For the shared state contract, behavior kernel, Classic/Liquid painters, native
parity, and phased control migration, follow
CONTROL-SYSTEM-REFORM.md.
