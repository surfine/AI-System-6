...
and SHA-256. `scripts/build-platinum-core-icons.mjs` is the accepted-core source;
the broad `scripts/build-era-icons.mjs` reapplies it last so a full rebuild
