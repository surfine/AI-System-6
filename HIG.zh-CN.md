<!-- canonical-source: HIG.md -->
<!-- source-sha256: 042060968c7272ea3936974bd591086079abd5780e70864f70cd243224bf91a2 -->

# AI System 6 人机界面指南

> 中文参考版。英文版为准；本文件仅供人类参考。

本文是 AI System 6 的规范性界面与排版规格，把 [CLAUDE.md](CLAUDE.md)
和 [DESIGN.md](DESIGN.md) 中的产品与视觉原则，转化成开发新应用时可以重复使用的决定。
